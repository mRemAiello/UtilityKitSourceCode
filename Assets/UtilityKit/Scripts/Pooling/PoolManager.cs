...
namespace MCFramework
{
    ...
    public class PoolManager : Singleton<PoolManager>
    {
        ...
        /// <returns></returns>
        public static Poolable GetPoolable(Poolable poolablePrefab)
        {
            if (!Instance.m_Pools.ContainsKey(poolablePrefab))
            {
                Instance.m_Pools.Add(poolablePrefab, new AutoComponentPrefabPool<Poolable>(poolablePrefab, Instance.Initialize, null,
                                                                                  poolablePrefab.initialPoolCapacity));
            }

            AutoComponentPrefabPool<Poolable> pool = Instance.m_Pools[poolablePrefab];
        ...
        public static void ReturnPoolable(Poolable poolable)
        {
